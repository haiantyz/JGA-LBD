...
class KarrasDenoiser:
    ...
    def training_bridge_losses(self, model, x_start, sigmas, model_kwargs=None, noise=None, vae=None):
        ...
        xT = model_kwargs['xT']
        smpl_condition= model_kwargs['smpl']
        if noise is None:
        ...
        # predicted_occupancy = denoised[:,-1,:,:,:].flatten()
        # gt_occupancy = x_start[:,-1,:,:,:].flatten()
        # # print(predicted_occupancy.shape)
        # # print(gt_occupancy.shape)
        # predicted_occupancy = predicted_occupancy[gt_occupancy==1]
        # gt_occupancy = gt_occupancy[gt_occupancy==1]
