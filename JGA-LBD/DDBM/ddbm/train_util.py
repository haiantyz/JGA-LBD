...
class TrainLoop:
    ...
    def _load_and_sync_parameters(self):
        ...
        if resume_checkpoint:
            ...
            self.model.load_state_dict(
                ...
                # ),
                th.load(resume_checkpoint, map_location=dist_util.dev()), strict=False
            )
    ...
    def run_loop(self):
        ...
        while True:
            ...
            for batch, partial_cond, smpl_condition, image_condition in self.data:
                ...
                cond = {'xT': partial_cond, 'smpl': smpl_condition, 'cond_text': image_condition}
                ...
                if took_step and self.step % self.save_interval == 0:
                    ...
                    test_batch, test_partial_cond, test_smpl_cond, test_image_cond = next(iter(self.test_data))
                    ...
                    test_cond = {'xT': test_partial_cond, 'smpl': test_smpl_cond, 'cond_text':test_image_cond}
